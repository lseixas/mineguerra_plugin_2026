...
|-------|-------------------|--------|
| `inicio` | Sexta 18:00 | PvP **off** + broadcast de abertura |
...
No `onEnable`, tudo que já venceu é reaplicado **em silêncio** (sem repetir
broadcast) e o border volta a encolher se `fechar-centro` já tinha rodado.
Fase já aplicada não roda de novo — inclusive o spawn do Trapaceiro, que não
duplica em restart.
