 ...
 */
public final class NoSpawnParticleHelper {
    ...
    public static void drawExisting(Player viewer, NoSpawnZone zone) {
        drawBox(viewer, zone.minX(), zone.minY(), zone.minZ(), zone.maxX(), zone.maxY(), zone.maxZ(), EXISTING, 1.0);
    }

    public static void flashConfirm(World world, NoSpawnZone zone) {
        if (world == null) {
            return;
        }
